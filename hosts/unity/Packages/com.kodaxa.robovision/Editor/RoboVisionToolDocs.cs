...
namespace Kodaxa.RoboVision.Editor
{
    internal static class RoboVisionToolDocs
    {
        ...
        private static JObject ObjectRef() => StringSchema("RoboVision Unity id: persistent unity:GlobalObjectId_* when available, otherwise session-scoped unity:instance:<id>");
